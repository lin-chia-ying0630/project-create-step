...
| 項目 | 內容 | 證據 |
|---|---|---|
| 目標 | 建立要保資料，送交核保，承保後建立正式保單 | Confirmed：使用者需求 |
...
- 要保作業人員：建立、修改草稿與送核保。
- 批次承保作業：領取待處理案件、執行基本檢核、建立照會或自動承保。
...
流程狀態與核保決定分開保存。公開資料可確認臺灣壽險的要保作業包含收件、資料完整性檢核、
...
- [中華郵政：要保作業處理流程](https://www.post.gov.tw/post/internet/Insurance/index.jsp?ID=4010203)：可確認資料檢視、補正、核保、拒／緩保、部分承保、承保與製發保單等作業節點。
