...
public record ProductDefinitionDto(String productCode, String productVersion, String productName,
		...
		String productRiskLevelCode, Integer minimumEntryAge, Integer maximumEntryAge, BigDecimal minimumSumAssured,
		...
		LocalDate effectiveFrom, LocalDate effectiveTo, boolean investmentProduct, String createdBy,
		LocalDateTime createdAt, String updatedBy, LocalDateTime updatedAt, String reviewerId,
