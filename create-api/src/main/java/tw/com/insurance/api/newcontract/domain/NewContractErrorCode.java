...
public enum NewContractErrorCode implements ErrorCode {
	...
	PRODUCT_TERM_VIOLATION("NCT-4223", "保險期間或繳費期間不符合商品定義"),
	PRODUCT_PAYMENT_MODE_VIOLATION("NCT-4224", "商品不支援指定繳別"),
	PRODUCT_RIDER_VIOLATION("NCT-4225", "附約不可搭配目前主約商品版本"),
	INVALID_ATTACHMENT("NCT-4226", "附件格式、大小、雜湊或受控檔案參照無效"),
