...
import type { UnderwritingBatchExecutionSummary, UnderwritingBatchRequest, UnderwritingBatchRequestResult } from '../types/underwritingBatch'

export const underwritingBatchApi = {
  enqueue(command: UnderwritingBatchRequest, idempotencyKey: string): Promise<UnderwritingBatchRequestResult> {
